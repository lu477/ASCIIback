...
def parse_args():
    ...
    parser.add_argument('-f', '--fontsize', help='Font size.', type=int, default=10)
    parser.add_argument('-b', '--bold', help='Boldness of characters. Recommended: 1/10 font size.', type=int, default=1)
    parser.add_argument('-bg', '--background', help='Background color. Must be 255 (white) or 0 (black).', type=int, default=0)
